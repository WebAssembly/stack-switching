...
and eq_cont_type (ContT ht1) (ContT ht2) =
  eq_heap_type ht1 ht2

and eq_def_type dt1 dt2 =
  match dt1, dt2 with
  | DefFuncT ft1, DefFuncT ft2 -> eq_func_type ft1 ft2
  | DefContT ct1, DefContT ct2 -> eq_cont_type ct1 ct2
  | _, _ -> false

and eq_table_type (TableT (lim1, t1)) (TableT (lim2, t2)) =
  eq_limits lim1 lim2 && eq_ref_type t1 t2

and eq_memory_type (MemoryT lim1) (MemoryT lim2) =
  eq_limits lim1 lim2

and eq_global_type (GlobalT (mut1, t1)) (GlobalT (mut2, t2)) =
  eq_mutability mut1 mut2 && eq_val_type t1 t2

and eq_tag_type (TagT ht1) (TagT ht2) =
  eq_heap_type ht1 ht2

and eq_extern_type et1 et2 =
  match et1, et2 with
  ...
  | ExternTagT t1, ExternTagT t2 -> eq_tag_type t1 t2
  | _, _ -> false
...
and match_def_type dt1 dt2 =
  ...
  | DefContT ct1, DefContT ct2 -> match_cont_type ct1 ct2
  | _, _ -> false

and match_table_type (TableT (lim1, t1)) (TableT (lim2, t2)) =
  match_limits lim1 lim2 && eq_ref_type t1 t2

and match_cont_type (ContT ht1) (ContT ht2) =
  match_heap_type ht1 ht2

and match_memory_type (MemoryT lim1) (MemoryT lim2) =
  match_limits lim1 lim2

and match_global_type (GlobalT (mut1, t1)) (GlobalT (mut2, t2)) =
...
let match_extern_type et1 et2 =
  ...
  | ExternTagT t1, ExternTagT t2 -> match_tag_type t1 t2
  | _, _ -> false
